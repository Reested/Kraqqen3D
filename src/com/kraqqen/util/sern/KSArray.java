...
public class KSArray extends KSBase {
	...
	public static KSArray Byte(String name, byte[] data) {
	...
	public static KSArray Short(String name, short[] data) {
		KSArray array = new KSArray();
		array.setName(name);
	...
	public static KSArray Char(String name, char[] data) {
		KSArray array = new KSArray();
		array.setName(name);
	...
	public static KSArray Integer(String name, int[] data) {
		KSArray array = new KSArray();
		array.setName(name);
	...
	public static KSArray Long(String name, long[] data) {
		KSArray array = new KSArray();
		array.setName(name);
	...
	public static KSArray Float(String name, float[] data) {
		KSArray array = new KSArray();
		array.setName(name);
	...
	public static KSArray Double(String name, double[] data) {
		KSArray array = new KSArray();
		array.setName(name);
	...
	public static KSArray Boolean(String name, boolean[] data) {
		KSArray array = new KSArray();
		array.setName(name);
	...
	public static KSArray Deserialize(byte[] data, int pointer) {
		byte containerType = data[pointer++];
		assert(containerType == CONTAINER_TYPE);
		
		KSArray result = new KSArray();
