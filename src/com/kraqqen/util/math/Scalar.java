...
public class Scalar {
	 ...
	 * @return
	 */
	public static double expm1(double n) {
		return Math.expm1(n);
	}
	 ...
	 * @return
	 */
	public static int getExponent(double n) {
	 ...
	 * @return
	 */
	public static int getExponent(float n) {
		return Math.getExponent(n);
	}
	 ...
	 * @return
	 */
	public static double log1p(double n) {
		return Math.log1p(n);
	}
	 ...
	 * @return
	 */
	public static long negateExact(long n) {
		return Math.negateExact(n);
	}
	 ...
	 * @return
	 */
	public static float nextDown(float n) {
		return Math.nextDown(n);
	}
	 ...
	 * @return
	 */
	public static float signum(float n) {
		return Math.signum(n);
	}
	 ...
	 * @return
	 */
	public static double ulp(double n) {
		return Math.ulp(n);
	}
